...
class Parser:
	...
	def __GetContent(self) -> dict:
		...
		if Response.status_code == 200:
			...
			# Запись в лог ошибки.
			self.__Logger.request_error(Response, "Unable to request element.")
	...
	def __GetServer(self) -> str:
		...
		if Response.status_code == 200:
			...
			# Запись в лог ошибки.
			self.__Logger.request_error(Response, "Unable to request site constants.")
	...
	def __GetSlides(self, number: str, volume: str, branch_id: str) -> list[dict]:
		...
		if Response.status_code == 200:
			...
			# Запись в лог ошибки.
			self.__Logger.request_error(Response, "Unable to request element content.")
