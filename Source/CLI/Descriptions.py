...
# ComPos.add_argument(ValidableTypes.All, description = "Extension name.")
# ComPos.add_argument(ValidableTypes.Alpha, description = "Parser name.")
...
ComPos.add_key("classificator", ValidableTypes.All, "Unknown type of classificator.")
ComPos.add_key("genre", ValidableTypes.All, "Genre.")
ComPos.add_key("franchise", ValidableTypes.All, "Franchise.")
ComPos.add_key("tag", ValidableTypes.All, "Tag.")
