...
get [URL*] [SITE*] [KEYS]
```
Скачивает изображение с целевого сайта.

**Описание позиций:**
* **URL** – ссылка на изображение. Обязательная позиция.
	* Аргумент – ссылка на изображение.
* **SITE** – указатель целевой платформы. Обязательная позиция.
	* Ключи:
		* _**--site**_ – указывает доменное имя целевого ресурса вместе с доменным пространством (например, _site.com_). Используется для настройки заголовка запроса _Referer_.
